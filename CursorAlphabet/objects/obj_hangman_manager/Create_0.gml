...
time_limit_level_1 = 120 * room_speed;  // 60 seconds for Level 1
time_limit_level_2 = 240 * room_speed;  // 90 seconds for Level 2
time_limit_level_3 = 240 * room_speed; // 120 seconds for Level 3
